...
RSpec.describe SpecBrowsersController, type: :controller do
  ...
  # SpecBrowsersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new SpecBrowser' do
        expect do
          post :create, params: { spec_browser: valid_attributes }, session: valid_session
        end.to change(SpecBrowser, :count).by(1)
      end

      it 'redirects to the created spec_browser' do
        post :create, params: { spec_browser: valid_attributes }, session: valid_session
        expect(response).to redirect_to(SpecBrowser.last)
      end
    end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'redirects to the spec_browser' do
        spec_browser = SpecBrowser.create! valid_attributes
        put :update, params: { id: spec_browser.to_param, spec_browser: valid_attributes }, session: valid_session
        expect(response).to redirect_to(spec_browser)
      end
    end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested spec_browser' do
      spec_browser = SpecBrowser.create! valid_attributes
      expect do
        delete :destroy, params: { id: spec_browser.to_param }, session: valid_session
      end.to change(SpecBrowser, :count).by(-1)
    end
