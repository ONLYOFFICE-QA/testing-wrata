...
module TestManager
  ...
  def execute_docker_command(command)
    ...
    generate_ssh_command("docker rm $(docker ps -a -q); docker pull onlyofficetestingrobot/nct-at-testing-node; docker run --privileged=true onlyofficetestingrobot/nct-at-testing-node bash -c \"#{shm_increase}sudo mount -a; #{command}\"")
  end
